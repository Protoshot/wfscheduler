 ...
 * 
 * @namespace Alfresco
 * @class Alfresco.FardoDocListToolbar
 */
(function()
{
    /**
    ...
    /**
     * FardoDocListToolbar constructor.
     * 
     * @param {String} htmlId The HTML id of the parent element
     * @return {Alfresco.FardoDocListToolbar} The new FardoDocListToolbar
     *         instance
     * @constructor
     */
    Alfresco.component.CustomStartWorkflow = function(htmlId)
    {
        return Alfresco.component.CustomStartWorkflow.superclass.constructor.call(this, htmlId);
    };

    /**
     * Extend Alfresco.DocListToolbar
     */
    YAHOO.extend(Alfresco.component.CustomStartWorkflow, Alfresco.component.StartWorkflow,
    {
        ...
        onWorkflowFormLoaded: function CustomStartWorkflow_onWorkflowFormLoaded(response)
        {
           ...
           formEl.innerHTML = '<div id="wfScheduler-activator"><input class="formsCheckBox" id="wfSheduler-checkbox" type="checkbox" tabindex="0" name="-" value="true" onchange="disableContainer(this)"><label for="wfSheduler-checkbox" class="checkbox">' + this.msg("sheduler.title") + '</label></div>' + response.serverResponse.responseText;
